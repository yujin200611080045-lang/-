      ...
      {phase === 'playing' && listenTab === 'together' && (
        <div className="together-view">
          <div className="together-stage">
            ...
            {/* crack: sin⁴ profile — only wide at center, shoulders narrow fast */}
            <svg className="together-crack" viewBox="0 0 320 340" xmlns="http://www.w3.org/2000/svg">
              <polygon
                className="crack-fill"
                points="0,0 22,25 46,49 60,81 85,104 86,148 116,166 119,209 162,214 177,246 222,249 243,275 274,292 296,317 320,340 298,315 279,287 261,258 247,226 221,205 220,160 200,132 158,126 143,94 98,91 77,65 48,46 23,24"
              />
              <polyline className="crack-edge"
                points="0,0 22,25 46,49 60,81 85,104 86,148 116,166 119,209 162,214 177,246 222,249 243,275 274,292 296,317 320,340"
              />
              <polyline className="crack-edge"
                points="0,0 23,24 48,46 77,65 98,91 143,94 158,126 200,132 220,160 221,205 247,226 261,258 279,287 298,315 320,340"
              />
            </svg>
