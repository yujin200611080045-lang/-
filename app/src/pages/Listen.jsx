      ...
      {phase === 'playing' && listenTab === 'together' && (
        <div className="together-view">
          <div className="together-stage">
            ...
            {/* crack: corners flattened at user-marked bends */}
            <svg className="together-crack" viewBox="0 0 320 340" xmlns="http://www.w3.org/2000/svg">
              <polygon
                className="crack-fill"
                points="0,0 22,25 44,51 58,87 86,108 126,162 124,208 170,210 180,248 210,264 248,274 273,296 298,318 320,340 298,316 278,292 263,259 246,230 218,210 196,138 112,82 74,68 50,43 22,23"
              />
              <polyline className="crack-edge"
                points="0,0 22,25 44,51 58,87 86,108 126,162 124,208 170,210 180,248 210,264 248,274 273,296 298,318 320,340"
              />
              <polyline className="crack-edge"
                points="0,0 22,23 50,43 74,68 112,82 196,138 218,210 246,230 263,259 278,292 298,316 320,340"
              />
            </svg>
