      ...
      {phase === 'playing' && listenTab === 'together' && (
        <div className="together-view">
          <div className="together-stage">
            ...
            {/* crack: lens-shaped, nearly closed at corners, wide at center */}
            <svg className="together-crack" viewBox="0 0 320 340" xmlns="http://www.w3.org/2000/svg">
              <polygon
                className="crack-fill"
                points="0,0 19,28 44,50 49,91 80,108 78,156 117,165 116,211 162,214 169,253 217,254 232,286 273,293 293,320 320,340 297,316 277,289 269,251 254,219 226,200 221,158 200,132 161,123 148,90 106,84 86,57 49,46 23,24"
              />
              <polyline className="crack-edge"
                points="0,0 19,28 44,50 49,91 80,108 78,156 117,165 116,211 162,214 169,253 217,254 232,286 273,293 293,320 320,340"
              />
              <polyline className="crack-edge"
                points="0,0 23,24 49,46 86,57 106,84 148,90 161,123 200,132 221,158 226,200 254,219 269,251 277,289 297,316 320,340"
              />
            </svg>
