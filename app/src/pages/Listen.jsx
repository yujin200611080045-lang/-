      ...
      {phase === 'playing' && listenTab === 'together' && (
        <div className="together-view">
          <div className="together-stage">
            ...
            {/* crack: flat tips (edges offset from corner), sin^2.5 width profile */}
            <svg className="together-crack" viewBox="0 0 320 340" xmlns="http://www.w3.org/2000/svg">
              <polygon
                className="crack-fill"
                points="0,15 22,25 44,51 56,85 84,104 84,150 124,158 122,206 170,207 178,245 208,262 247,271 272,294 297,316 320,325 305,340 298,315 276,290 262,257 245,228 216,209 217,162 198,134 172,113 125,112 110,79 73,69 51,44 23,24 15,0"
              />
              <polyline className="crack-edge"
                points="0,15 22,25 44,51 56,85 84,104 84,150 124,158 122,206 170,207 178,245 208,262 247,271 272,294 297,316 320,325"
              />
              <polyline className="crack-edge"
                points="15,0 23,24 51,44 73,69 110,79 125,112 172,113 198,134 217,162 216,209 245,228 262,257 276,290 298,315 305,340"
              />
            </svg>
